                ...
                <Card>
                    <CardBody>
                        <form onSubmit={handleCreateService} className="flex flex-col gap-4">
                            {submitError && <div className="p-3 bg-neutral-100 dark:bg-neutral-800 text-neutral-700 dark:text-neutral-300 rounded-lg text-sm border border-neutral-300 dark:border-neutral-700">{submitError}</div>}
                            {submitSuccess && <div className="p-3 bg-neutral-100 dark:bg-neutral-800 text-neutral-700 dark:text-neutral-300 rounded-lg text-sm border border-neutral-300 dark:border-neutral-700">{submitSuccess}</div>}
                            ...
                            <div className="flex flex-col gap-1.5 w-full">
                                ...
                                <select
                                    className="px-3 py-2 bg-white dark:bg-neutral-800 border border-neutral-300 dark:border-neutral-600 rounded-xl outline-none focus:ring-2 focus:ring-neutral-400 focus:border-neutral-400 transition-colors duration-300 text-sm"
                                    value={type}
            ...
            <div className="lg:col-span-2">
                ...
                {loading ? (
                    ...
                    <div className="text-center p-12 bg-surface rounded-xl border border-border-subtle border-dashed">
                        <Settings2 className="w-12 h-12 text-neutral-500 opacity-70 mx-auto mb-4" />
